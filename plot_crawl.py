...
print('Plotting ...')
p = sns.pointplot(data=df_0, hue='lnrho', y='rrmsd', x='sigma', palette='GnBu_d')
p.figure.savefig('0_lnrho_vs_rrmsd.png')
plt.clf()
p = sns.pointplot(data=df_1, hue='lnrho', y='rrmsd', x='sigma', palette='GnBu_d')
p.figure.savefig('1_lnrho_vs_rrmsd.png')
plt.clf()
p = sns.pointplot(data=df_2, hue='lnrho', y='rrmsd', x='sigma', palette='GnBu_d')
